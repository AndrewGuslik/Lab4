...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageControl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mediaPlayer.isPlaying())
                {
                    ...
                    mediaPlayer.pause();
                    imageControl.setImageResource(R.drawable.cobainnotlive);
                } else
                {
                    ...
                    mediaPlayer.start();
                    imageControl.setImageResource(R.drawable.cobainlive);
                }
            }
        });
        ...
        btnSongsHist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, SongHistory.class);
        ...
        protected void onPostExecute(String result) {
            ...
            if(songInfos.length != 0){
                ...
                if(value == 1){
                    ...
                    cv.put(DatabaseHandler.COLUMN_MUSICIAN, songInfos[0]);
                    cv.put(DatabaseHandler.COLUMN_NAME, songInfos[1]);
                    cv.put(DatabaseHandler.COLUMN_TIMEADD, formattedDate);
